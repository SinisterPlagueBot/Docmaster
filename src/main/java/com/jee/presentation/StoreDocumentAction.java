...
public class StoreDocumentAction extends Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		String username= request.getParameter("doc_owner_username");
		...
		String file_path ="D:"+File.separator+"docmaster_docdb"+File.separator+doc_title;
		Document new_doc = new Document(doc_title,doc_desc,file_path);
		  
		facade.addDoc(new_doc);
		Access doc_ownership= new Access(user.getId(),facade.getDocBytitle(doc_title).getId(),"o");
...
try {
        ...
        File outputFile = new File(tempDir,doc_title);
